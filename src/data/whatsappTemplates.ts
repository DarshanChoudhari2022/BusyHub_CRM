...
export const WHATSAPP_TEMPLATES = {
  ...
  CLIENT_GREETING: (name: string) => 
    `*Hi ${name}*,\n\nHope you're having a great day! This is from *BuzyHub*. \n\nJust checking in to see if there's anything else we can help you with today. 😊`,

  // Partners & Collaborations
  PARTNER_GREETING: (name: string) => 
    `*Hi ${name}*,\n\nThis is from *BuzyHub*. We're looking forward to our upcoming collaboration! Please reach out if you have any updates. 🤝`,
