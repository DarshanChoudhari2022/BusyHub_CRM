...
-- ============================================================================
-- SAFE ALTER TABLES TO ENSURE COLUMNS EXIST (in case tables were already created)
-- ============================================================================
...
ALTER TABLE public.shop_visits ADD COLUMN IF NOT EXISTS google_map_link TEXT;
